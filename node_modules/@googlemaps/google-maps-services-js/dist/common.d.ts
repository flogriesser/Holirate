...
export declare enum PlaceIdScope {
    /**
...
export declare enum AspectRatingType {
    appeal = "appeal",
...
export declare enum TrafficModel {
    /**
...
export declare enum TransitMode {
...
export declare enum TransitRoutingPreference {
 ...
 * @deprecated
 */
export declare enum DirectionsReponseStatus {
    /** indicates the response contains a valid `result`. */
    OK = "OK",
    /** indicates at least one of the locations specified in the request's origin, destination, or waypoints could not be geocoded. */
    NOT_FOUND = "NOT_FOUND",
...
export declare enum GeocodedWaypointStatus {
