...
var OrsPois = function () {
  function OrsPois(args) {
    ...
    if (_constants2.default.propNames.apiKey in args) {
      ...
      throw new Error(_constants2.default.missingAPIKeyMsg);
    }
  ...
  _createClass(OrsPois, [{
    ...
    value: function generatePayload(args) {
      ...
      for (var key in args) {
        if (_constants2.default.baseUrlConstituents.indexOf(key) > -1 || key === _constants2.default.propNames.apiKey || key === _constants2.default.propNames.timeout) {
          continue;
        } else {
    ...
    value: function poisPromise() {
      ...
      return new _bluebird2.default(function (resolve, reject) {
        var timeout = that.args[_constants2.default.propNames.timeout] || 5000;
